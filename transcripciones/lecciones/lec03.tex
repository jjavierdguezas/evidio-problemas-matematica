...
\parbox[][][t]{.67\linewidth}{
 ...
 \begin{itemize}
     ...
     \item[v $\cdot\hspace{0.05cm}\text{-}$] $A_{ABCD} = \sqrt{\rho(\rho-a)(\rho-b)(\rho-c)(\rho-d)}$\\($\rho$ semiperímetro)
 \end{itemize}
}
...
Como vimos en 1.iv, en todo $CC$ el producto de las diagonales es igual a la suma del producto de los lados opuestos.

\vspace{0.5cm}
\noindent\parbox[][][t]{.3\linewidth}{
    \begin{tikzpicture}[scale=1.2]
      \coordinate [label=above:$A$] (A) at (-0.8,1.83);
      \coordinate [label=right:$B$] (B) at (1.2,1.02);
      \coordinate [label=right:$C$] (C) at (1.37,-0.31);
      \coordinate [label=left:$D$] (D) at (-1.91,-0.58);
      \coordinate [label=left:$Q$] (Q) at (0.16,0.48);
      
      \coordinate [label=above:$P$] (P) at (0.43,0.62);
      \coordinate (O) at (-0.32,0.15);
    ...
    %   \filldraw (Q) circle[radius=1.5pt];
      ...
      \tkzLabelAngle[pos=0.3](D,A,C){$x$}; 
      \tkzLabelAngle[pos=0.3](D,B,C){$x$}; 
      \tkzLabelAngle[pos=0.5](C,A,B){$*$}; 
      \tkzLabelAngle[pos=0.5](C,D,B){$*$}; 
      \tkzMarkAngle[size=0.5cm,arc=l,mark=none](Q,C,D);
      \tkzMarkAngle[size=0.5cm,arc=l,mark=none](B,C,P);
